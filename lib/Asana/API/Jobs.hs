...
-- 
getJob 
  :: JobGid -- ^ "jobGid" -  Globally unique identifier for the job.
  -> AsanaRequest GetJob MimeNoContent InlineResponse2007 MimeJSON
getJob (JobGid jobGid) =
  _mkRequest "GET" ["/jobs/",toPath jobGid]
...
instance HasOptionalParam GetJob OptPretty where
...
instance HasOptionalParam GetJob OptFields where
